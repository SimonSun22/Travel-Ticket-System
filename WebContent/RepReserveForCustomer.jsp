...
<body>
<a href='LoginSuccessRep.jsp'>Home</a></p><br>
<a href='Logout.jsp'>Log out</a></p><br>

<form action="RepReserveCheck.jsp" method="POST"  >
Type the customer userid here: <input type="text" name="userid"/> <br/>
Type the departure airport here: <input type="text" name="d_air"/> <br/>
Type the arrival airport here: <input type="text" name="a_air"/> <br/>
